...
OWNER_NAME: process.env.OWNER_NAME || "POPKID-MD",
DESCRIPTION: process.env.DESCRIPTION || "*© POPKID-MD*",
ALIVE_IMG: process.env.ALIVE_IMG || "𝗦𝗘𝗘𝗡 𝗬𝗢𝗨𝗥 𝗦𝗧𝗔𝗧𝗨𝗦 𝗕𝗬 𝗣𝗢𝗣𝗞𝗜𝗗 𝗫𝗧𝗥🔄",
